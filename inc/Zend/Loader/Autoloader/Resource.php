 ...
 * @version    $Id: Resource.php,v 1.1 2014/03/04 10:40:37 cvs Exp $
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */

/** Zend_Loader_Autoloader_Interface */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Loader/Autoloader/Interface.php';
...
class Zend_Loader_Autoloader_Resource implements Zend_Loader_Autoloader_Interface
{
    ...
    public function __construct($options)
    {
        ...
        if (!is_array($options)) {
            require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Loader/Exception.php';
