 ...
 * @version    $Id: PluginLoader.php,v 1.1 2014/03/04 10:40:08 cvs Exp $
 */

/** Zend_Loader_PluginLoader_Interface */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Loader/PluginLoader/Interface.php';
...
class Zend_Loader_PluginLoader implements Zend_Loader_PluginLoader_Interface
{
    ...
    public function addPrefixPath($prefix, $path)
    {
        if (!is_string($prefix) || !is_string($path)) {
            require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Loader/PluginLoader/Exception.php';
