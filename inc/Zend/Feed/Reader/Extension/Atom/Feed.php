 ...
 * @version    $Id: Feed.php,v 1.1 2014/03/04 10:41:03 cvs Exp $
 */

/**
 * @see Zend_Feed_Reader_Extension_FeedAbstract
 */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Feed/Reader/Extension/FeedAbstract.php';
