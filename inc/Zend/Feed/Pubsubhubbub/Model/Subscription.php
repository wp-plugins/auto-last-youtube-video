...
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Feed/Pubsubhubbub/Model/ModelAbstract.php';

/** @see Zend_Feed_Pubsubhubbub_Model_SubscriptionInterface */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Feed/Pubsubhubbub/Model/SubscriptionInterface.php';
