 ...
 * @version    $Id: Entry.php,v 1.1 2014/03/04 10:40:36 cvs Exp $
 */
...
class Zend_Feed_Writer_Extension_ITunes_Entry
{
    ...
    public function __call($method, array $params)
    {
        ...
        if (!method_exists($this, 'setItunes' . ucfirst($point))
            ...
            require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Feed/Writer/Exception/InvalidMethodException.php';
