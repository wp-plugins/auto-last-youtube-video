 ...
 * @version    $Id: Entry.php,v 1.1 2014/03/04 10:40:41 cvs Exp $
 */
 
/**
 * @see Zend_Feed_Writer_Extension_RendererAbstract
 */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Feed/Writer/Extension/RendererAbstract.php';
