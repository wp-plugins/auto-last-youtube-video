 ...
 * @version    $Id: Feed.php,v 1.1 2014/03/04 10:40:23 cvs Exp $
 */
 ...
 * @see Zend_Date
 */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Uri.php';

/**
 * @see Zend_Feed_Writer
 */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Feed/Writer.php';

/**
 * @see Zend_Feed_Writer_Entry
 */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Feed/Writer/Entry.php';

/**
 * @see Zend_Feed_Writer_Deleted
 */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Feed/Writer/Deleted.php';

/**
 * @see Zend_Feed_Writer_Renderer_Feed_Atom
 */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Feed/Writer/Renderer/Feed/Atom.php';

/**
 * @see Zend_Feed_Writer_Renderer_Feed_Rss
 */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Feed/Writer/Renderer/Feed/Rss.php';

require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Feed/Writer/Feed/FeedAbstract.php';
