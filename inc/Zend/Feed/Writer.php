 ...
 * @version    $Id: Writer.php,v 1.1 2014/03/04 10:39:16 cvs Exp $
 */
    ...
    public static function getPluginLoader()
    {
        if (!isset(self::$_pluginLoader)) {
            ...
            self::$_pluginLoader = new Zend_Loader_PluginLoader(array(
                'Zend_Feed_Writer_Extension_' => $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Feed/Writer/Extension/',
            ));
        }
