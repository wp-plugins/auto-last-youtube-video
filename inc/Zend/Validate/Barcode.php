 ...
 * @version    $Id: Barcode.php,v 1.1 2014/03/04 10:40:19 cvs Exp $
 */
...
class Zend_Validate_Barcode extends Zend_Validate_Abstract
{
    ...
    public function setAdapter($adapter, $options = null)
    {
        ...
        require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Loader.php';
        if (Zend_Loader::isReadable($_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Validate/Barcode/' . $adapter. '.php')) {
