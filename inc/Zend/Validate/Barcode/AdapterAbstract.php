 ...
 * @version    $Id: AdapterAbstract.php,v 1.1 2014/03/04 10:39:07 cvs Exp $
 */

/**
 * @see Zend_Validate_Barcode_AdapterInterface
 */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Validate/Barcode/AdapterInterface.php';
