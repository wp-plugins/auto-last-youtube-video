 ...
 * @version    $Id: PostCode.php,v 1.1 2014/03/04 10:40:19 cvs Exp $
 */

/**
 * @see Zend_Validate_Abstract
 */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Validate/Abstract.php';

/**
 * @see Zend_Locale_Format
 */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Locale/Format.php';
...
class Zend_Validate_PostCode extends Zend_Validate_Abstract
{
    ...
    public function __construct($options = null)
    {
        ...
        if (empty($options)) {
            require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Registry.php';
        ...
        if (empty($format)) {
            require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Validate/Exception.php';
    ...
    {
        require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Locale.php';
