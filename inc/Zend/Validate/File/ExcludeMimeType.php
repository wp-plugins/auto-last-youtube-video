 ...
 * @version   $Id: ExcludeMimeType.php,v 1.1 2014/03/04 10:39:29 cvs Exp $
 */

/**
 * @see Zend_Validate_File_MimeType
 */
require_once $_SESSION['AUTO_LAST_YOUTUBE_VIDEO_PATH'].'inc///Zend/Validate/File/MimeType.php';
